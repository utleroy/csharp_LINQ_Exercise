...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(cohort => cohort.Name).ToList();
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(cohort => cohort.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(Cohort => Cohort.Birthday).ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(juniorInstructors => juniorInstructors.LastName).ToList();

...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohorts => cohorts.Active == true).ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(primary => primary.PrimaryInstructor.FirstName == "Jurnell").ToList();

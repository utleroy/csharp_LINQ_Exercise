...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(cohort => cohort.FullTime == true && cohort.PrimaryInstructor.Birthday.Year > 2017);
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(cohort => cohort.Name == "Zelda" || cohort.Name == null);
        ...
        {
            var shouldThrowException = PracticeData.First(cohort => cohort.FullTime == false && cohort.Active == false);
        }
